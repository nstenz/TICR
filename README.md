...
* [TICR](#ticrR) to test panmixia, binary tree, and partial tree with current or ancestral panmictic populations
...
and the tree created by get-pop-tree.pl. 
...
```
and then TICR.r can be run from the command line:
